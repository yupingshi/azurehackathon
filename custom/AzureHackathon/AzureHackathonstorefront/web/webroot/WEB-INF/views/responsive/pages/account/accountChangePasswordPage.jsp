	...
	<div class="container-lg col-md-6">
		<div class="account-section-content">
			<div class="account-section-form">
				<form:form action="${action}" method="post" commandName="updatePasswordForm" id="mypasswordform" >
						...
						<div class="col-sm-6 col-sm-push-6">
							<div class="accountActions">
								<button type="button" class="btn btn-primary btn-block" onclick="enrollNewVerificationProfile();">
									<spring:theme code="updatePwd.cvp" text="Create Voice Verification Profile" />
								</button>
							</div>
						</div>
					</div>
